...
### For small fixes (typos, factual corrections)

1. Navigate to the relevant page on the website
2. Click "Edit this page" (links to GitHub)
3. Make your edit in GitHub's web editor
4. Submit a pull request with a brief description of the change
5. An editor will review and merge

### For larger contributions

1. **Open an Issue** first: describe what you want to contribute and why. This allows the editorial board to provide feedback before you invest time writing.
...
4. **Submit a pull request** with a description of the content and how it fits The ELSA Way
5. **Respond to review comments**: the editorial board may request revisions before merging
...
- Be practical: contributions should be actionable, not just theoretical
