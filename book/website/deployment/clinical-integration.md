...
Deploying an AI system means integrating it into a complex sociotechnical system — the clinical workflow — that was not designed around it. Technical integration is the easier part; workflow integration is the harder part.
