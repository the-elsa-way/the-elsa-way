...
Healthcare AI operates in a dense regulatory environment. Understanding which frameworks apply to your system — and when — is a design-phase responsibility, not something to address at the point of deployment.

## The EU AI Act

The EU AI Act (2024) classifies AI systems according to risk level. Healthcare AI is presumptively classified as **high-risk**:
...
AI systems that are intended to diagnose, monitor, treat, or predict disease may qualify as medical devices under EU MDR (2017/745) or IVD devices under IVDR (2017/746).
...
Processing patient data for AI development and deployment requires a lawful basis under GDPR:
...
- **ISO 14971** — Risk management for medical devices (applicable to AI)
