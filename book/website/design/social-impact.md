...
AI in healthcare does not only affect individual patients — it affects clinicians, healthcare systems, communities, and society. These broader impacts should be considered at the design stage, before technical choices are made that are difficult to reverse.
...
AI can widen or narrow health disparities. If a tool works better for patients who are well-represented in its training data — often patients in high-income settings, majority ethnic groups, patients with standard presentations — then deploying it broadly will provide greater benefit to the already-advantaged.
