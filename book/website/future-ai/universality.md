...
The universality principle states that healthcare AI tools should be generalisable to new clinical settings, equipment, and user populations outside the setting where they were developed.
...
Universality is not achieved at a single point. It requires designing for generalisability (representative data, standard formats), validating generalisability (external, multi-site validation), and monitoring generalisability (local validation, drift detection in deployment).
