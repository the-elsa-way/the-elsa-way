...
For AI development, ethical review addresses both the use of patient data (which is typically subject to research ethics requirements) and the intended clinical application of the AI system.
