...
A model that outperforms a clinician on a held-out dataset in controlled conditions does not necessarily improve outcomes in the real world. Bridging the gap between benchmark performance and clinical benefit is one of the central challenges in healthcare AI evaluation.
