...
:class: tip
This chapter supports **Fairness recommendation 3**: Evaluate fairness and debiasing measures {cite}`lekadir2025futureai`.
:::

An AI model that is accurate on average may still systematically disadvantage specific groups of patients. Fairness evaluation makes this visible, and it is a prerequisite for responsible deployment.
...
- Confidence intervals (subgroup samples may be small, so confidence intervals will be wide)
