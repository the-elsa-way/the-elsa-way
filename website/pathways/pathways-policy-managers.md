...
This pathway is for hospital managers, procurement officers, health technology assessment teams, and policy makers responsible for institutional AI governance.
...
- **EU AI Act** (2024) {cite}`euaiact2024`: classifies healthcare AI as high-risk; requires conformity assessment, transparency, human oversight
