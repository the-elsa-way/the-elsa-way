...
This pathway is for academic researchers studying, developing, or validating AI in clinical settings.
...
12. [FUTURE-AI Principles](../future-ai/future-ai.md) (all 30 recommendations)

## Key reporting standards

- **TRIPOD-AI** {cite}`tripodai2024`: for reporting clinical prediction models using AI
- **CLAIM** {cite}`claim2020`: for reporting AI studies in medical imaging
- **CONSORT-AI** {cite}`consortai2020`: for randomised trials involving AI interventions
